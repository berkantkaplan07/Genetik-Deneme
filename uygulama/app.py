...
<style>
    ...
    /* Menü ve Giriş Kutusu Düzeltmeleri */
    .stSelectbox div[data-baseweb="select"] > div { background-color: #ffffff !important; color: #000000 !important; }
    div[data-baseweb="popover"] { background-color: #ffffff !important; border: 1px solid #ddd !important; }
    ul[data-baseweb="menu"] li { background-color: #ffffff !important; color: #000000 !important; }
    ul[data-baseweb="menu"] li:hover { background-color: #F2F2F7 !important; }
...
# HATA VEREN SATIRI DÜZELTTİM VE KISATTIM:
alt_baslik = "<p style='text-align: center; color: #666 !important;'>Yapay Zeka Destekli Varyant Analizi</p>"
st.markdown(alt_baslik, unsafe_allow_html=True)
...
if analyze:
    ...
    if known_disease:
        html = f"""
        <div style='background-color: #ffe5e5; padding: 15px; border-radius: 15px; border-left: 6px solid #ff3b30;'>
